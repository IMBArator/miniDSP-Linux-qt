"""Delay settings panel for output channels (placeholder).

A blank placeholder shown when the user navigates to the Delay feature
from an output strip. Real controls will land here once the delay
protocol writer is wired up; for now it mirrors the look of the other
feature panels (title + framed body) so the detail view stays
consistent.
...
class DelayPanel(QWidget):
    """Placeholder panel for output-channel delay settings."""
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        body = QLabel("Delay controls are not yet available.")
